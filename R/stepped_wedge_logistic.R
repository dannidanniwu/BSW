...
#mod <- cmdstan_model("./stepped_wedge_logistic.stan")
set_cmdstan_path(path = "/gpfs/share/apps/cmdstan/2.25.0") 
mod <- cmdstan_model("/gpfs/data/troxellab/danniw/r/BS/stepped_wedge_logistic.stan")
...
s_model <- function(train_data, mod) {
  ...
  #s(k): Nonlinear effect of time
  #s(k, site, bs = "fs"): Site-specific nonlinear effect of time
