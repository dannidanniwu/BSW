...
bayes_p_sd2_5 = bayes_performance(truth, res$est_med_bayes2_5, res$lowci_bayes2_5, res$upci_bayes2_5,res$est_sd_bayes2_5)
round(unlist(bayes_p_sd2_5),3)

bayes_p_sd1 = bayes_performance(truth, res$est_med_bayes1, res$lowci_bayes1, res$upci_bayes1,res$est_sd_bayes1)
...
type1_errors <- c(
  ...
  bayes_p_sd2_5$type1error,
  bayes_p_sd1$type1error
)
...
coverage_true <- c(
  ...
  bayes_p_sd2_5$coverage,
  bayes_p_sd1$coverage
)
