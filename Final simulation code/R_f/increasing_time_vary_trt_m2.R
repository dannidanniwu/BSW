...
dir.create(file.path("/gpfs/data/troxellab/danniw/scratch/m2_increasing_time_vary_trt"), showWarnings = FALSE)

# Write the result to a file
output_filename <- paste0("output_iter_", iter, ".RData")
#save(result, file=output_filename)

save(result, file = paste0("/gpfs/data/troxellab/danniw/scratch/m2_increasing_time_vary_trt/", output_filename))
