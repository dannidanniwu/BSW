...
mod <- cmdstan_model("/gpfs/data/troxellab/danniw/r/BS/time_vary_cluster_specific_trt_our_m3.stan")
...
dir.create(file.path("/gpfs/data/troxellab/danniw/scratch/m3_cluster_specific_time_vary_trt"), showWarnings = FALSE)

# Write the result to a file
output_filename <- paste0("output_iter_", iter, ".RData")

save(result, file = paste0("/gpfs/data/troxellab/danniw/scratch/m3_cluster_specific_time_vary_trt/", output_filename))
