...
library(priorsense)
# compared to no_sigma ended code version, add sigma_beta_star in to prior sensitivity test
mod <- stan_model("./time_varying_trt_priorsense_beta_sigma.stan")
...
setwd("C:/My PC (DESKTOP-52UHO48)/Desktop/Bayesian Spline/Bayesian stepped wedge/Bayesian stepped wedge/Bayesian-stepped-wedge/Final simulation code/Code for paper revision/output/R1_q8")
res <- powerscale_sensitivity(fit)
save(res,file="./time_vary_priorsense_res_beta_sigma.rda")
