...
mod <- stan_model("./cluster_specific_time_varying_trt_priorsense_beta_sigma.stan")
...
res2 <- powerscale_sensitivity(fit)
save(res2,file="./cluster_spf_time_vary_bayes_priorsense_res_beta_sigma.rda")
