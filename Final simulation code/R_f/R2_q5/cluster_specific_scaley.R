...
#mod <- cmdstan_model("./cluster_specific_trt_scaley.stan")
mod <- cmdstan_model("/gpfs/home/dw2625/r/Review_sim/stan/cluster_specific_trt_scaley.stan")
...
save(res, file = paste0("/gpfs/home/dw2625/r/Review_sim/results/", date_stamp, "/cluster_specific_trt_scaley.rda"))
