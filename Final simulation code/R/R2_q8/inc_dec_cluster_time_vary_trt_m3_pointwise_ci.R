...
#mod <- cmdstan_model("./cluster_specific_time_varying_trt.stan")
mod <- cmdstan_model("/gpfs/home/dw2625/r/Review_sim/stan/cluster_specific_time_varying_trt.stan")
...
s_model <- function(train_data, mod) {
  ...
  #true value of TATE
  t_values <- 1:t_ex_mx
  true_eff = unique(train_data[t%in%t_values,t_effect_overall])
...
save(res, file = paste0("/gpfs/home/dw2625/r/Review_sim/results/", date_stamp, "/inc_dec_cluster_specific_trt_m3_pointwise_ci.rda"))
